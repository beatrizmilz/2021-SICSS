...
data <- buscar_classe("mw-changeslist-date")
caracteres_removidos <- buscar_classe("mw-plusminus-neg mw-diff-bytes")
caracteres_adicionados <- buscar_classe("mw-plusminus-pos mw-diff-bytes")

tabela_suja <- tibble::tibble(data, caracteres_removidos, caracteres_adicionados)
